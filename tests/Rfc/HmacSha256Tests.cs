...
namespace NSec.Tests.Rfc
{
    ...
    {
        public static readonly TheoryData<string, string, string> Rfc4231TestVectors = new()
        {
        ...
        public static readonly TheoryData<string, string, string> Rfc4868TestVectors = new()
        {
            // Section 2.7.2.1
