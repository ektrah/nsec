...
internal static partial class Interop
{
    internal static partial class Libsodium
    {
        ...
        [DllImport(Libraries.Libsodium, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UIntPtr crypto_aead_xchacha20poly1305_ietf_npubbytes();

        [DllImport(Libraries.Libsodium, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UIntPtr crypto_aead_xchacha20poly1305_ietf_nsecbytes();
    }
}
