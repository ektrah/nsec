...
namespace NSec.Cryptography
{
    ...
    {
        private static readonly KeyFormatter s_nsecPrivateKeyFormatter = new Ed25519KeyFormatter(crypto_sign_ed25519_SEEDBYTES, new byte[] { 0x7F, 0x34, 0x42, 0, crypto_sign_ed25519_SEEDBYTES, 0, 0, 0 });
